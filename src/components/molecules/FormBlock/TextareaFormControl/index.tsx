...
export default function TextareaFormControl(props) {
    ...
    return (
        <div className={classNames({ 'sm:col-span-2': width === 'full' })}>
            ...
            <textarea
                id={name}
                className="rounded-xl w-full p-3 bg-transparent border border-current placeholder:text-current placeholder:opacity-50 focus:outline-none focus:ring-1 focus:ring-current sm:text-xl"
                name={name}
                rows="5"
                {...attr}
            />
